...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-expander .elastislide-wrapper, #huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-details .infosep{
	display:none;
}

#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-details a.link-button{
	border:0 !important;
}
